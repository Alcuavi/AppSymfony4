 ...
 */
final class Version20190702111637 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE resultado (id INT AUTO_INCREMENT NOT NULL, equipolocal_id INT NOT NULL, equipo_visitante_id INT NOT NULL, puntoslocal INT NOT NULL, puntosvisitante INT NOT NULL, cancha VARCHAR(255) NOT NULL, fecha DATETIME NOT NULL, INDEX IDX_B2ED91C643C565E (equipolocal_id), INDEX IDX_B2ED91C8C243011 (equipo_visitante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
